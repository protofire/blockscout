defmodule Explorer.Chain.StakingLog do
  ...
  alias Explorer.Chain.{Address, Block, ContractMethod, Data, Hash, StakingLog, StakingTransaction}
  ...
  @type t :: %__MODULE__{
          ...
          transaction: %Ecto.Association.NotLoaded{} | StakingTransaction.t(),
          transaction_hash: Hash.Full.t(),
          index: non_neg_integer()
        }

  @primary_key false
  schema "staking_logs" do
    field(:data, Data)
    ...
    belongs_to(:transaction, StakingTransaction,
  ...
  `address_hash` and `transaction_hash` are converted to `t:Explorer.Chain.Hash.t/0`.
      ...
      iex> changeset = Explorer.Chain.StakingLog.changeset(
      ...>   %Explorer.Chain.StakingLog{},
      ...>   %{
  ...
  @doc """
  Decode staking transaction log data.
  """
  @spec decode(StakingLog.t(), StakingTransaction.t(), any(), boolean, map(), map()) ::
  ...
  def find_and_decode(abi, log, transaction_hash) do
    ...
    e ->
      Logger.warn(fn ->
        [
          "Could not decode input data for staking log from transaction hash: ",
