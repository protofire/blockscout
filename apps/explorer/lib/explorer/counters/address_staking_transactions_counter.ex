defmodule Explorer.Counters.AddressStakingTransactionsCounter do
  @moduledoc """
  Caches Address staking transactions counter.
  """
  use GenServer
  ...
  @cache_name :address_staking_transactions_counter
  ...
  defp update_cache(address) do
    ...
    new_data = Counters.address_to_staking_transactions_count(address)
  ...
  defp put_into_db(address, value) do
    address
    |> Changeset.change(%{staking_transactions_count: value})
    |> Repo.update()
  end
